...
export class AppLayoutBaseService {
  ...
  config : any = {"left":[{"infiniteScroll":false,"element":"logo"},{"infiniteScroll":false,"menuType":"fixed","hideSidebarOnCollapse":false,"element":"leftMenu"},{"infiniteScroll":false,"element":"appTitle"}],"middle":[{"infiniteScroll":false,"element":"leftPane"},{"infiniteScroll":false,"element":"middlePane"},{"infiniteScroll":false,"element":"rightPane"}],"right":[{"element":"user"},{"infiniteScroll":false,"menuType":"float","element":"rightMenu"},{"infiniteScroll":false,"menuType":"float","element":"navigationTabs"}]};
