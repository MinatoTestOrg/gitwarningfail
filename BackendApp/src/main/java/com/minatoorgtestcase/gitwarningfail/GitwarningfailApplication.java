package com.minatoorgtestcase.gitwarningfail;
...
@SpringBootApplication(scanBasePackages = {"com.vs.rappit","com.vs","com.minatoorgtestcase.gitwarningfail"})
@EnableCaching
...
public class GitwarningfailApplication {

	public static void main(String[] args) {
		SpringApplication.run(GitwarningfailApplication.class, args);
	}
