package com.minatoorgtestcase.gitwarningfail.base.service;
...
import com.minatoorgtestcase.gitwarningfail.base.service.IApplicationUserBaseService;
import com.minatoorgtestcase.gitwarningfail.model.Roles;
...
public abstract class ApplicationUserBaseService<T extends ApplicationUserBase> extends BaseBusinessLogic<T> implements IApplicationUserBaseService<T>
{
	...
	public ApplicationUserBaseService(Class<T> modelClass) {
		...
		addPersistenceOption(AnalyticalOptions.GROUP_NAME, "78c9d6b3-2ea4-4d0d-9db6-108346684931");
